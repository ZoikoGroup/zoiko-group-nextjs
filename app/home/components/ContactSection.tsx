          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-[1.2fr_1fr] sm:items-start">
            ...
            <ul className="grid grid-cols-2 gap-4">
              <li className="flex flex-col items-center gap-2 rounded-xl bg-white px-3 py-5 text-center">
                <Image src={phoneIcon} alt="" aria-hidden="true" className="h-6 w-6" />
                <a
              ...
              <li className="flex flex-col items-center gap-2 rounded-xl bg-white px-3 py-5 text-center">
                <Image src={mailIcon} alt="" aria-hidden="true" className="h-6 w-6" />
                <a
                  href={`mailto:${EMAIL}`}
              ...
              <li className="flex flex-col items-center gap-2 rounded-xl bg-white px-3 py-5 text-center">
                <Image src={streetIcon} alt="" aria-hidden="true" className="h-6 w-6" />
              ...
              <li className="flex flex-col items-center gap-2 rounded-xl bg-white px-3 py-5 text-center">
                <Image src={openMapIcon} alt="" aria-hidden="true" className="h-6 w-auto" />
                <a
                  href={MAP_URL}
                  target="_blank"
